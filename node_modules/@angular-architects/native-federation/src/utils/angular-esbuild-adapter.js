...
function runEsbuild(builderOptions_1, context_1, entryPoints_1, external_1, outdir_1, tsConfigPath_1, mappedPaths_1, watch_1) {
    return tslib_1.__awaiter(this, arguments, void 0, function* (builderOptions, context, entryPoints, external, outdir, tsConfigPath, mappedPaths, watch, rebuildRequested = new rebuild_events_1.RebuildHubs(), dev, kind, hash = false, plugins = null, absWorkingDir = undefined, logLevel = 'warning', platform, optimizedMappings) {
        ...
        const config = Object.assign({ entryPoints: entryPoints.map((ep) => ({
                in: ep.fileName,
                out: path.parse(ep.outName).name,
            })), outdir, entryNames: hash ? '[name]-[hash]' : '[name]', write: false, absWorkingDir,
            external,
            logLevel, bundle: true, sourcemap: sourcemapOptions.scripts, minify: !dev, supported: {
                'async-await': false,
                'object-rest-spread': false,
            }, splitting: true, platform: platform !== null && platform !== void 0 ? platform : 'browser', format: 'esm', target: target, logLimit: kind === 'shared-package' ? 1 : 0, plugins: plugins || [
                ...
                ...(mappedPaths && mappedPaths.length > 0
                    ...
                    : []),
                commonjsPlugin(),
            ], define: Object.assign(Object.assign({}, (!dev ? { ngDevMode: 'false' } : {})), { ngJitMode: 'false' }) }, (builderOptions.loader ? { loader: builderOptions.loader } : {}));
