...
function runBuilder(nfOptions, context) {
    return tslib_1.__asyncGenerator(this, arguments, function* runBuilder_1() {
        ...
        try {
            federationResult = yield tslib_1.__await((0, build_6.buildForFederation)(config, fedOptions, externals));
        }
        catch (e) {
            console.error(e);
            if (!watch) {
            ...
            for (var _d = true, builderRun_1 = tslib_1.__asyncValues(builderRun), builderRun_1_1; builderRun_1_1 = yield tslib_1.__await(builderRun_1.next()), _a = builderRun_1_1.done, !_a; _d = true) {
                ...
                if (!first && (nfOptions.dev || watch)) {
                    setTimeout(() => tslib_1.__awaiter(this, void 0, void 0, function* () {
                        try {
                            federationResult = yield (0, build_6.buildForFederation)(config, fedOptions, externals);
                            if (hasLocales && localeFilter) {
                                (0, i18n_1.translateFederationArtefacts)(i18n, localeFilter, outputOptions.base, federationResult);
                            }
